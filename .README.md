...
## Pages
The concept of **pages** WRT the client refers to what is displayed at any particular URI. Pages comprise **modules**. These are defined in [client/src/modules](client/src/pages).

#### [/home (/)](client/src/pages/home/)
